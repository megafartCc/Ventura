...
-- ==================================================
-- VEHICLE ESP (simple detection from workspace.Cars)
-- ==================================================
...
local function getVehDisplayName(car)
    ...
    local ok, result = pcall(function()
        ...
        local cm = info:FindFirstChild("CarModel")
        local ow = info:FindFirstChild("Owner")
        local modelName = cm and cm:IsA("StringValue") and cm.Value or nil
        local ownerName = ow and ow:IsA("StringValue") and ow.Value or nil
